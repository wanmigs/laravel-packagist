...
/***/ "./resources/js/admin/pages/resource/create.js":
/*!*****************************************************!*\
  !*** ./resources/js/admin/pages/resource/create.js ***!
  \*****************************************************/
...
var Create = function Create() {
  ...
  var _useState11 = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])({}),
      ...
      endpoint = _useState12[0],
      setEndpoint = _useState12[1];
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              setLoading(true);
              api = endpoint.store || "/api/resource/".concat(slug);
              _context2.next = 7;
              return Object(_helpers_utilities__WEBPACK_IMPORTED_MODULE_4__["formSubmit"])("post", api, formData, "".concat(title.singular, " successfully added"), "/admin/resource/".concat(slug));
  ...
  }, "Create ", title.singular), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("form", {
    ref: form,
