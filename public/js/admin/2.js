...
/***/ "./resources/js/admin/pages/permission/create.js":
/*!*******************************************************!*\
  !*** ./resources/js/admin/pages/permission/create.js ***!
  \*******************************************************/
...
var Create = function Create() {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              setLoading(true);
              _context.next = 6;
              return Object(_helpers_utilities__WEBPACK_IMPORTED_MODULE_4__["formSubmit"])("post", "/api/permission", formData, "Permission successfully added", "/admin/permissions");
  ...
  }, "Create Permission"), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("form", {
    ref: form,
