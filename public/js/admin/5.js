...
/***/ "./resources/js/admin/pages/roles/edit.js":
/*!************************************************!*\
  !*** ./resources/js/admin/pages/roles/edit.js ***!
  \************************************************/
...
/* harmony import */ var _form__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./form */ "./resources/js/admin/pages/roles/form.js");
...
var EditRole = function EditRole() {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return axios.get("/api/role/".concat(id));
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              setLoading(true);
              _context2.next = 6;
              return Object(_helpers_utilities__WEBPACK_IMPORTED_MODULE_4__["formSubmit"])("patch", "/api/role/".concat(id), formData, "Role successfully updated", "/admin/roles");
  ...
  }, "Edit Role"), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("form", {
    ref: form,
    data: data,
...
/***/ "./resources/js/admin/pages/roles/form.js":
/*!************************************************!*\
  !*** ./resources/js/admin/pages/roles/form.js ***!
  \************************************************/
